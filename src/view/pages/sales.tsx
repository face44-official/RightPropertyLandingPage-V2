...
const TrackPerformanceImproveStrategy = () => {
    const [points, setPoints] = useState<Points>({ "topLeft": { "x": 583.111083984375, "y": 48.12498474121094 }, "topRight": { "x": 1341.111083984375, "y": 171.12498474121094 }, "bottomRight": { "x": 1225.111083984375, "y": 717.1249847412109 }, "bottomLeft": { "x": 505.111083984375, "y": 489.12498474121094 } });
    return <div className="relative">
        ...
        <div className="absolute top-0 left-0 w-full h-full">
            <PerspectiveTransform storageKey="example-transform" points={points} onPointsChange={setPoints} editable={false}>
                <video src={trackVideo} className="w-[18.75rem] h-full" autoPlay muted loop playsInline />
