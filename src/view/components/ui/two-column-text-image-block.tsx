...
export default function TwoColumnTextImageBlock({ title, description, image, className, variant,id }: { title: string | React.ReactNode, description: string, image: string | React.ReactNode, className?: string, variant: 'image-left' | 'image-right', id?: string }) {
    ...
    return (
        <section className={cn(classNames, variantClasses[variant])} id={id}>
