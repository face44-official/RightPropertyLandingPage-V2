                ...
                <div className="flex w-full  lg:flex-col lg:gap-0 mobile-rp-container lg:m-auto">
                    <div className="group relative grow basis-[100%] overflow-hidden">
                        ...
                        <div className='absolute left-[5rem] top-[4.0625rem] lg:top-6 lg:left-6'>
                            <h3 className="mb-3 font-general-sans font-medium text-40 lg:text-36 lg:px-0 leading-[130%] text-raisin-black relative z-[2]">
                                surface
                            </h3>
                            <p className="mb-[6.625rem] lg:mb-[2.5rem] lg:px-0] font-geist font-normal  text-22 leading-[140%] text-squid-ink relative z-[2]">
                    ...
                    <div className="group relative grow basis-[100%] overflow-hidden">
                        ...
                        <div className='absolute left-[5rem] top-[4.0625rem] lg:top-6 lg:left-6'>
                            <h3 className="mb-3 font-general-sans font-medium text-40 lg:text-36 lg:px-0 leading-[130%] text-white relative z-[2]">
                                space
                            </h3>
