...
import macbookImage from "@/assets/v3/marketing/macbook_pro2.webp";

export default function MarketingHeroSection() {
    return (
        <div className="flex justify-center rp-container">
            <div className="relative inline-block">
                <img src={macbookImage} className="w-[62.5rem] h-auto mb-[9.375rem] lg:w-full lg:px-4 relative z-0" alt="Right Property marketing platform displayed on MacBook Pro" />
