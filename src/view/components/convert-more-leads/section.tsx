...
export default function ConvertMoreLeadsSection() {
    const items = [
        {
            icon: <img src={startIcon} alt="Performance tracking feature icon" className="w-[5rem] 4k:w-[6.5rem] h-auto object-contain" />,
        ...
        {
            icon: <img src={spaceIcon} alt="User-centered platform feature icon" className="w-[5rem] 4k:w-[6.5rem] h-auto object-contain" />,
    ...
    return (
        <div className="mb-[30rem] lg:mb-[0] bg-[#EEF1F7] h-[45.25rem] 4k:h-[65rem] lg:h-auto overflow-visible relative content-visibility-auto">
            ...
            <section className="">
                ...
                <div className="rp-container lg:bg-none! lg:h-auto! relative z-[8] flex p-[7.5rem] justify-start lg:p-4">
                    <img src={convertMoreLeads} alt="Right Property lead conversion insights desktop background" className="z-[-1] h-[63.25rem] 4k:h-[85rem] absolute top-0 left-0 w-full lg:hidden" />
