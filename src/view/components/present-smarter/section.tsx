...
export default function PresentSmarterSection() {
  ...
  return (
    ...
    >
      <section>
        {/* Mobile Background */}
        <div className="hidden lg:block bg-[#EEF1F7] lg:pb-10">
          <img
        ...
        >
          ...
          <div
            ...
            "
          >
            <div className="image-wrap absolute left-0 top-0 w-[56vw] object-top object-cover overflow-hidden lg:hidden">
              <div
                className="
