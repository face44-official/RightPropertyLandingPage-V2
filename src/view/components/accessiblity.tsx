...
export const AccessibilityHeaderInformation = ({
  ...
  <>
    ...
    <h2 className="
      ...
      4k:[font-size:clamp(4rem,calc(4rem+((100vw-2000px)/2000px)*4rem),8rem)]
...
export const AccessibilityItems = ({
  ...
  <div className="
    ...
    4k:[gap:clamp(3rem,calc(3rem+((100vw-2000px)/2000px)*3rem),6rem)]
  ...
  ">
    {items.map((item, i) => (
      <div key={i} className="
        ...
        gap-8 lg:gap-3
        4k:[gap:clamp(2rem,calc(2rem+((100vw-2000px)/2000px)*2rem),4rem)]
      ">
        {item.icon}
        <div>
          <h3 className="
            ...
            leading-[140%]
            text-[18px]
            4k:[font-size:clamp(1.125rem,calc(1.125rem+((100vw-2000px)/2000px)*1.125rem),2.25rem)]
          ">
            {item.title}
          </h3>
          <p className="
...
export default function Accessibility({
  ...
  return (
    ...
    ">
      ...
      <div><BookADemoButton /></div>
      <div className="mb-[3.75rem] lg:mb-[2rem] 4k:[margin-bottom:clamp(4rem,calc(4rem+((100vw-2000px)/2000px)*4rem),7rem)]"></div>

      {/* Items */}
      <div className="
        flex flex-col gap-[1.9375rem] lg:w-full
        4k:[gap:clamp(1.9375rem,calc(1.9375rem+((100vw-2000px)/2000px)*1.9375rem),3.875rem)]
      ">
        {items.map((item, index) => (
          <div
            ...
            className="
              ...
              rounded-[20px]
              4k:[border-radius:clamp(20px,calc(20px+((100vw-2000px)/2000px)*20px),40px)]
            "
