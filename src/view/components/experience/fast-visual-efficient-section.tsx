import fastRoad from "@/assets/v3/experience/presentation_surface_illustration.svg";
...
export default function FastVisualEfficientSection() {
    ...
    return (
        <section id="simple-setup relative z-[6]" className="" aria-label="Simple setup process for Right Property platform">
            <div className="rp-container lg:h-auto! lg:pb-[7.5rem]" style={{ height: "78.5625rem" }}>
                ...
                <div className="flex justify-start gap-[8.4375rem] w-[41.875rem] lg:w-full">
                    <div className="absolute top-0 left-0 w-[136.6875rem] h-[109.6875rem] lg:hidden z-[1]">
                        <img className='w-full h-full' src={fastRoad} alt="Right Property Surface 2D fast and efficient interface visualization" loading="lazy" decoding="async" width="1680" height="1734" />
                    ...
                    <div ref={gradientRef} style={{ background: "radial-gradient(50% 50% at 50% 50%, #DBE8FF 0%, #E8F4FF 25.96%, rgba(255, 255, 255, 0) 100%)" }} className="lg:hidden absolute -top-[12rem] -right-[20rem] w-[1425.84px] h-[1425.84px]"></div>

                    <div className="pt-[9.375rem] pl-[5rem] lg:p-4">
