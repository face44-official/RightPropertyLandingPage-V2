import fastRoad from "@/assets/v3/experience/fast_efficient_illustration.png";
import { useRef } from "react";
import purpleCheck from "@/assets/v3/purple_check.png";
import efficientMobile from '@/assets/v3/experience/efficient_mobile.png';
    ...
    return (
        <section id="simple-setup" className="" aria-label="Simple setup process for Right Property platform">
            <div className="rp-container lg:h-auto! lg:pb-[7.5rem]" style={{ height: "78.5625rem" }}>
                ...
                <img src={efficientMobile} className="hidden lg:block w-full h-auto" alt="" />
                ...
                <div className="flex justify-start gap-[8.4375rem] w-[41.875rem] lg:w-full">
                    ...
                    <img className='absolute top-0 left-0 w-full h-auto lg:hidden z-[1]' src={fastRoad} alt="Right Property simple setup interface demonstration" loading="lazy" decoding="async" width="1680" height="1734" />
