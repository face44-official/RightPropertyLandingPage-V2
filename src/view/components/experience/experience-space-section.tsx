...
export default function ExperienceSpaceSection() {
    return (
        <div className="bg-black  pb-[9.375rem] lg:pb-[3.75rem]">
            <section id="experience-space" className="rp-container !px-[5rem] lg:px-4" aria-label="Choose the experience">
                <div className="group relative mt-[7.5rem] lg:mt-[4rem] mb-[2.5rem]">
                    <div className="w-full h-auto overflow-hidden">
                        <img src={spaceFullImage} alt="surface full" className="w-full h-auto group-hover:scale-105 transition-all duration-600 ease-in-out" />
                    </div>
