...
export default function BookADemoButton({ className }: { className?: string }) {
  const cnClass = cn(
    ...
    `,
    `
    4k:[width:clamp(14.5625rem,calc(14.5625rem+((100vw-2050px)/2000px)*14.5625rem),29.125rem)]
    ...
    text-2k-4k
    4k:[letter-spacing:clamp(0em,calc(0em+((100vw-2050px)/2000px)*0.05em),0.05em)]
    4k:[padding-left:clamp(2.25rem,calc(2.25rem+((100vw-2050px)/2000px)*2.25rem),4.5rem)]
    hover:4k:[padding-left:clamp(5.25rem,calc(5.25rem+((100vw-2050px)/2000px)*5.25rem),10.5rem)]
    `,
    className
  );
  ...
  return (
      ...
      <button className={cnClass}>
        ...
        <div
          className="
            ...
            4k:[right:clamp(5px,calc(5px+((100vw-2050px)/2000px)*5px),10px)]
            4k:[width:clamp(3.5rem,calc(3.5rem+((100vw-2050px)/2000px)*3.5rem),7rem)]
            4k:[height:clamp(3.375rem,calc(3.375rem+((100vw-2050px)/2000px)*3.375rem),6.75rem)]
            group-hover:4k:[width:clamp(10.875rem,calc(10.875rem+((100vw-2050px)/2000px)*10.875rem),21.75rem)]
          "
        >
          <svg
            className="transition-transform duration-300 ease-in-out group-hover:translate-x-[14em] 4k:group-hover:translate-x-[28em]
                       4k:[width:clamp(24px,calc(24px+((100vw-2050px)/2000px)*24px),48px)]
                       4k:[height:clamp(25px,calc(25px+((100vw-2050px)/2000px)*25px),50px)] xl:w-[18px] xl:h-[19px]"
            width="24"
            height="25"
            viewBox="0 0 24 25"
            fill="none"
    ...
    4k:[left:clamp(1.125rem,calc(1.125rem+((100vw-2050px)/2000px)*1.125rem),2.25rem)]
    4k:[-translate-x:clamp(5rem,calc(5rem+((100vw-2050px)/2000px)*5rem),10rem)]
    4k:[width:clamp(24px,calc(24px+((100vw-2050px)/2000px)*24px),48px)]
    4k:[height:clamp(25px,calc(25px+((100vw-2050px)/2000px)*25px),50px)]
  "
          width="24"
          height="25"
          viewBox="0 0 24 25"
