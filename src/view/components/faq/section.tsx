    ...
    <div id="faqs" className="bg-black content-visibility-auto">
      <section
        className="
          ...
          4k:[max-width:clamp(1680px,calc(1680px+((100vw-2050px)/2000px)*520px),2200px)]
          4k:[padding-top:clamp(7.5rem,calc(7.5rem+((100vw-2050px)/2000px)*7.5rem),15rem)]
          4k:[padding-bottom:clamp(7.5rem,calc(7.5rem+((100vw-2050px)/2000px)*7.5rem),15rem)]
          4k:[padding-left:clamp(5rem,calc(5rem+((100vw-2050px)/2000px)*5rem),10rem)]
          4k:[padding-right:clamp(5rem,calc(5rem+((100vw-2050px)/2000px)*5rem),5rem)]
        "
      ...
      >
        ...
        {/* FAQ Grid */}
        <div className="flex gap-[30px] lg:flex-col lg:gap-2 4k:[gap:clamp(30px,calc(30px+((100vw-2050px)/2000px)*30px),60px)]">
          <div className="flex-1 space-y-6 lg:space-y-2 4k:[space-y:clamp(6rem,calc(6rem+((100vw-2050px)/2000px)*4rem),10rem)]">
